...
import { getUserProviderById } from 'apiSdk/user-providers';
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            User Provider Detail View
          </Text>
          {hasAccess('user_provider', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/user-providers/edit/${data?.id}`} passHref legacyBehavior>
              <Button
